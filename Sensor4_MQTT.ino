...
const char *topic = "PTZ/Batterielabor/AirQuality/Sensor_4"; // MQTT-Topic zur Datenübertragung (Auf die Endung /Sensor_X achten)
...
//Netzwerk Daten 
IPAddress local_IP(130, 149, 137, 183); // Statische IP-Adresse für den Sensor_4
