...
const char *topic = "PTZ/Batterielabor/AirQuality/Sensor_2"; // MQTT-Topic zur Datenübertragung (Auf die Endung /Sensor_X achten)
...
//Netzwerk Daten 
IPAddress local_IP(130, 149, 137, 181); // Statische IP-Adresse für den Sensor_2
